...
P(n):![](http://latex.codecogs.com/gif.latex?\forall{n}\exists)  way to tile a  <img src="./img/lect2/equation_6.png" alt="equation_6" style="zoom:50%;" /> region with any  square missing(for Bill).
